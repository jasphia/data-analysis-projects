...
popLast = cargo_hold.pop(-1)
print(popLast)
cargo_hold.pop(-1)

# Remove the first item from the list with pop. Print the element removed and the updated list.
popFirst = cargo_hold.pop(0)
print(popFirst)
cargo_hold.pop(0)

# append and insert require arguments inside the (). Add the items 1138 and ‘20 meters’ to the the list - the number at the start and the string at the end. 
